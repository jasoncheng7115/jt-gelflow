...
This is the operations-grade upgrade procedure for **JT-GELFLOW v1.5.5+**. Version updates pull from the public GitHub repo.
...
```bash
JT_GELFLOW_BRANCH=v1.5.5 \
  curl -fsSL https://raw.githubusercontent.com/jasoncheng7115/jt-gelflow/v1.5.5/install.sh | sudo bash
```

(Replace `v1.5.5` with the tag of your choice.)
