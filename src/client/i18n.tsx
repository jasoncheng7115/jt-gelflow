...
const translations: Record<Language, Record<string, string>> = {
  'en': {
    ...
    'settings.countryDisplayHint': 'Shown as the Sankey country column header. Country uses hardcoded GELF fields source_ip_country_code / destination_ip_country_code.',
  ...
  'zh-TW': {
    ...
    'settings.countryDisplayHint': '桑基圖國別欄的顯示文字。國碼使用固定的 GELF 欄位 source_ip_country_code / destination_ip_country_code。',
